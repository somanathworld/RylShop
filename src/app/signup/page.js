...
export default function SignUp() {
    ...
    async function handleSubmit(event) {
        ...
        if (data.success) {
            toast.success('Wow! User created', {
                position: "top-center",
                autoClose: 1500,
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="min-w-screen  flex items-center justify-center px-5 py-8">
                    ...
                    <div className="md:flex w-full">
                        <div className="hidden md:block w-1/2 bg-blue-500 py-10 px-10">
                            <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg" width="100%" length="auto" viewBox="0 0 744.84799 747.07702">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10 bg-blue-100">
                            ...
                            <div>
                                <div className="flex -mx-3">
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-0 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="bi bi-person-fill text-blue-400 text-lg"></i></div>
                                            <input onChange={(event) => setUserDetails({ ...userDetails, fname: event.target.value })} type="text" name="fname" id="fname" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" placeholder="John" />
                                        </div>
                                    </div>
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-0 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="bi bi-person-fill text-blue-400 text-lg"></i></div>
                                            <input onChange={(event) => setUserDetails({ ...userDetails, lname: event.target.value })} type="text" name="lname" id="lname" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" placeholder="Smith" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-0 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="bi bi-envelope-fill text-blue-400 text-lg"></i></div>
                                            <input onChange={(event) => setUserDetails({ ...userDetails, email: event.target.value })} type="email" name="email" id="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" placeholder="johnsmith@example.com" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-0 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="bi bi-lock-fill text-blue-400 text-lg"></i></div>
                                            <input onChange={(event) => setUserDetails({ ...userDetails, password: event.target.value })} type="password" name="password" id="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" placeholder="************" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                ...
                                <div>
                                    ...
                                    <Link href={"/login"} className="text-blue-600 font-bold hover:text-blue-700 hover:underline hover:underline-offset-4">Sign In</Link>
                                </div>
                            </div>
                        </div>
                    </div>
